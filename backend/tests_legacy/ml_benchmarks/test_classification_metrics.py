...
class TestClassificationMetrics:
    ...
    def test_overall_accuracy(
        self,
        trained_classifier,
        classification_test_data: Dict[str, Any]
    ):
        """
    ...
    def test_per_class_performance(
        ...
        for class_name, metrics in report.items():
            ...
            if isinstance(metrics, dict):
                ...
                display_name = class_name[:28] + '..' if len(class_name) > 30 else class_name
                
                print(f"{display_name:<30} {precision:>10.4f} {recall:>10.4f} {f1:>10.4f} {support:>10.0f}")
        ...
        if 'macro avg' in report:
            ...
            print(f"{'Macro Average':<30} {macro['precision']:>10.4f} {macro['recall']:>10.4f} {macro['f1-score']:>10.4f}")
        
        if 'weighted avg' in report:
            weighted = report['weighted avg']
            print(f"{'Weighted Average':<30} {weighted['precision']:>10.4f} {weighted['recall']:>10.4f} {weighted['f1-score']:>10.4f}")
    ...
    def test_confidence_calibration(
        ...
        for sample in samples:
            ...
            for min_conf, max_conf, bin_name in bins:
                if min_conf <= confidence < max_conf or (max_conf == 1.0 and confidence == 1.0):
        ...
        print("-" * 80)
        print(f"{'Confidence Bin':<25} {'Samples':>10} {'Correct':>10} {'Accuracy':>10}")
        print("-" * 80)
        ...
        medium_high_bin = bin_data.get("Medium-High (0.7-0.9)", {'total': 0, 'correct': 0})
        medium_high_accuracy = (medium_high_bin['correct'] / medium_high_bin['total'] 
                               if medium_high_bin['total'] > 0 else 0.0)
    ...
    def test_top_k_accuracy(
        ...
        for k in k_values:
            ...
            improvement_pct = (improvement / baseline_accuracy * 100) if baseline_accuracy > 0 else 0.0
