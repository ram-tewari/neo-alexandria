...
def test_sample_classification_result_fixture(sample_classification_result):
    ...
    assert all(isinstance(p, ClassificationPrediction) for p in sample_classification_result.predictions)
...
def test_mock_classification_service_fixture(mock_classification_service_with_domain_objects):
...
def test_mock_recommendation_service_fixture(mock_recommendation_service_with_domain_objects):
