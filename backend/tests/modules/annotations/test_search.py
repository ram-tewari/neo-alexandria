...
def test_fulltext_search_basic(db_session, create_test_resource, create_test_annotation):
    """
...
def test_fulltext_search_case_insensitive(db_session, create_test_resource, create_test_annotation):
    """
...
def test_fulltext_search_user_isolation(db_session, create_test_resource, create_test_annotation):
    """
...
def test_fulltext_search_pagination(db_session, create_test_resource, create_test_annotation):
    """
...
def test_fulltext_search_empty_query(db_session, create_test_resource, create_test_annotation):
    """
...
def test_fulltext_search_no_matches(db_session, create_test_resource, create_test_annotation):
    """
...
def test_tag_search_user_isolation(db_session, create_test_resource, create_test_annotation):
    """
...
def test_tag_search_empty_tags(db_session, create_test_resource, create_test_annotation):
    """
...
def test_tag_search_no_matches(db_session, create_test_resource, create_test_annotation):
    """
