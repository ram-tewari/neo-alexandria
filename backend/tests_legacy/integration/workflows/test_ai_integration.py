...
class TestAIIntegration:
    ...
    def test_ai_summary_generation(self):
        ...
        assert any(
            ...
            for keyword in ["machine learning", "ai", "algorithms", "python"]
        )
    ...
    def test_ai_tag_generation(self):
        ...
        assert any(
            keyword in tag_text
            for keyword in ["machine learning", "artificial intelligence", "python"]
        )
    ...
    def test_end_to_end_ai_processing(self, client, test_db, temp_dir):
        ...
        with (
            ...
            response = client.post(
                "/resources", json={"url": "https://example.com/ai-test"}
            )
            ...
            assert any(
                keyword in description or keyword in subjects
                for keyword in [
                    "machine learning",
