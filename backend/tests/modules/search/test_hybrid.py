...
class ReciprocalRankFusionService:
    ...
    def fuse(
        self, ranked_lists: List[List[str]], weights: List[float] = None
        ...
        ranked_ids = sorted(
            scores.keys(),
            key=lambda x: (-scores[x], best_rank[x], earliest_ranker[x], x),
        )
...
def test_rrf_fusion_basic():
    ...
    **Validates: Requirements 9.2, 9.3, 9.4, 9.5**
    ...
    assert_ranking_against_golden(
        "search_ranking", "rrf_fusion_scenario_1", ranked_ids, check_order=True
    )
...
def test_rrf_fusion_empty_lists():
    ...
    **Validates: Requirements 9.2, 9.3, 9.4, 9.5**
    ...
    # Assert against Golden Data
    assert_ranking_against_golden(
        "search_ranking", "rrf_fusion_empty_lists", ranked_ids, check_order=True
    )
...
def test_rrf_fusion_single_list():
    ...
    **Validates: Requirements 9.2, 9.3, 9.4, 9.5**
    ...
    # Assert against Golden Data
    assert_ranking_against_golden(
        "search_ranking", "rrf_fusion_single_list", ranked_ids, check_order=True
    )
