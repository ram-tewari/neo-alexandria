...
def test_markdown_export_single_resource(db_session, create_test_resource, create_test_annotation):
    """
...
def test_markdown_export_multiple_resources(db_session, create_test_resource, create_test_annotation):
    """
...
def test_markdown_export_without_tags(db_session, create_test_resource, create_test_annotation):
    """
...
def test_markdown_export_without_note(db_session, create_test_resource, create_test_annotation):
    """
...
def test_json_export_single_resource(db_session, create_test_resource, create_test_annotation):
    """
...
def test_json_export_multiple_resources(db_session, create_test_resource, create_test_annotation):
    """
...
def test_json_export_user_isolation(db_session, create_test_resource, create_test_annotation):
    """
    ...
    # Export as user1
    json_data_user1 = service.export_annotations_json(
        user_id="user1"
    )
    ...
    # Export as user2
    json_data_user2 = service.export_annotations_json(
        user_id="user2"
    )
...
def test_json_export_invalid_resource_id(db_session):
    ...
    with pytest.raises(ValueError, match="Invalid resource_id format"):
        service.export_annotations_json(
            user_id="test_user",
