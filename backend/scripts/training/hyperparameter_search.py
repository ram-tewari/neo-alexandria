...
class HyperparameterSearch:
    ...
    def __init__(
        ...
        self.train_samples = train_data if isinstance(train_data, list) else train_data.get('samples', [])
        self.val_samples = val_data if isinstance(val_data, list) else val_data.get('samples', [])
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Hyperparameter search for arXiv classification")
    parser.add_argument(
        "--data-dir",
        type=str,
