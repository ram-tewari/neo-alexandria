...
from backend.app.ml_monitoring.json_logging import JSONFormatter, configure_json_logging, log_with_context
...
class TestPredictionMonitor:
    ...
    def test_log_prediction(self):
        ...
        assert monitor.predictions[0]["input_length"] == len("Test paper about machine learning")
