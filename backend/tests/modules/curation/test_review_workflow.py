...
def test_review_queue_filtering(
    ...
    low_quality_1 = create_test_resource(
        title="Low Quality 1",
        quality_score=0.2
    )
    low_quality_2 = create_test_resource(
        title="Low Quality 2",
        quality_score=0.3
    )
    medium_quality = create_test_resource(
        title="Medium Quality",
        quality_score=0.6
    )
    high_quality = create_test_resource(
        title="High Quality",
        quality_score=0.9
    )
...
def test_empty_batch_operation(
    client: TestClient
):
    """
...
def test_review_queue_pagination(
    client: TestClient,
    create_test_resource
):
    """
