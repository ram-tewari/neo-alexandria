...
def small_dataset():
    ...
    for i in range(100):
        ...
        samples.append(
            {
                "text": f"This is a test paper about {category} with some content. "
                * 10,
                "label": category,
...
class TestClassificationTrainer:
    ...
    def test_trainer_initialization(self, temp_output_dir):
        ...
        trainer = ClassificationTrainer(
            model_name="distilbert-base-uncased", output_dir=temp_output_dir
        )
    ...
    def test_pytorch_dataset(self, small_dataset, temp_output_dir):
        ...
        dataset = ArxivClassificationDataset(
            small_dataset[:10], tokenizer, trainer.label_to_id
        )
    ...
    def test_end_to_end_training(self, temp_data_dir, temp_output_dir):
        ...
        train_metrics = trainer.train(
            train_samples, val_samples, epochs=1, batch_size=8, learning_rate=2e-5
        )
        ...
        )  # Should achieve >50% on small dataset
