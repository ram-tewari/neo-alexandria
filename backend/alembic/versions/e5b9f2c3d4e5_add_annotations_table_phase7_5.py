...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint('start_offset >= 0', name='ck_annotation_start_offset_nonnegative'),
        sa.CheckConstraint('end_offset >= 0', name='ck_annotation_end_offset_nonnegative'),
        sa.CheckConstraint('start_offset < end_offset', name='ck_annotation_offsets_valid')
    )
