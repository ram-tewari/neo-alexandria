...
try:
    ...
    for script_name in scripts:
        ...
        assert 'if __name__ == "__main__":' in content, (
            f"{script_name} missing main entry point"
        )
...
print("Next steps:")
print(
    "  1. Run quick test: python backend/scripts/evaluation/run_full_validation.py --quick-test"
)
print(
    "  2. Run full validation: python backend/scripts/evaluation/run_full_validation.py"
)
