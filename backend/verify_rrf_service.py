...
def main():
    ...
    test_queries = [
        ...
        ("How does gradient descent optimization work in deep neural networks?", "Long query (10+ words)"),
    ...
    for query, description in test_queries:
        ...
        print(f"  Weights: FTS5={weights[0]:.3f}, Dense={weights[1]:.3f}, Sparse={weights[2]:.3f}")
