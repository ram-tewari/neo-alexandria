...
class TestGEvalMetrics:
    ...
    @pytest.mark.skipif(not TRANSFORMERS_AVAILABLE, reason="transformers package not installed")
...
class TestEvaluateSummary:
    ...
    def test_evaluate_summary_without_g_eval(self, db_session: Session, sample_resource: Resource):
    ...
    @pytest.mark.skipif(not TRANSFORMERS_AVAILABLE, reason="transformers package not installed")
    def test_evaluate_summary_with_g_eval(self, db_session: Session, sample_resource: Resource):
    ...
    def test_evaluate_summary_updates_resource(self, db_session: Session, sample_resource: Resource):
    ...
    def test_evaluate_summary_composite_score(self, db_session: Session, sample_resource: Resource):
