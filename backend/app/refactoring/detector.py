...
class CodeSmellDetector:
    ...
    def prioritize_smells(self, reports: List[SmellReport]) -> PrioritizedSmells:
        ...
        high_priority.sort(key=lambda s: (str(s.location.file_path), s.location.start_line))
        medium_priority.sort(key=lambda s: (str(s.location.file_path), s.location.start_line))
        low_priority.sort(key=lambda s: (str(s.location.file_path), s.location.start_line))
