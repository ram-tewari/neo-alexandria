...
def main():
    ...
    baseline_precision = service.compute_precision_at_k(
        baseline_results, relevant_docs, k=5
    )
    ...
    enhanced_precision = service.compute_precision_at_k(
        enhanced_results, relevant_docs, k=5
    )
    ...
    judgments = {"doc1": 3, "doc2": 2, "doc3": 1, "doc4": 0, "doc5": 0}
