...
def upgrade():
    ...
    op.add_column('resources', sa.Column('ingestion_status', sa.String(), nullable=False, server_default='pending'))
    op.add_column('resources', sa.Column('ingestion_error', sa.Text(), nullable=True))
    op.add_column('resources', sa.Column('ingestion_started_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('resources', sa.Column('ingestion_completed_at', sa.DateTime(timezone=True), nullable=True))
