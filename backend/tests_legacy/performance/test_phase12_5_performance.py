...
def test_concurrent_ingestion_100(test_db):
    ...
    print(f"  Throughput: {num_concurrent / (overall_duration/1000):.1f} tasks/second")
    ...
    assert degradation_ratio < 5.0, f"Performance degradation {degradation_ratio:.2f}x exceeds 5x"
...
def test_cache_performance_hit_rate(test_db):
    ...
    computation_reduction = ((computation_time_without_cache - computation_time_with_cache) / 
