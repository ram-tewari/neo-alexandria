...
def sample_quality_score() -> QualityScore:
    ...
    """
    return QualityScore(
        accuracy=0.8, completeness=0.75, consistency=0.7, timeliness=0.85, relevance=0.8
    )
...
def sample_classification_result() -> ClassificationResult:
    ...
    """
    predictions = [
        ClassificationPrediction(taxonomy_id="006.31", confidence=0.85, rank=1),
        ClassificationPrediction(taxonomy_id="006.3", confidence=0.72, rank=2),
        ClassificationPrediction(taxonomy_id="004.6", confidence=0.65, rank=3),
    ]
...
def sample_recommendation() -> Recommendation:
    ...
    recommendation_score = RecommendationScore(score=0.88, confidence=0.82, rank=1)
