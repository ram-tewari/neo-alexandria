...
def handle_resource_viewed(payload: Dict[str, Any]):
    ...
    try:
        ...
        try:
            ...
            logger.info(
                f"Updated user profile for resource view: user={user_id}, resource={resource_id}"
            )
...
def handle_annotation_created(payload: Dict[str, Any]):
    ...
    try:
        ...
        try:
            ...
            logger.info(
                f"Updated user profile for annotation: user={user_id}, resource={resource_id}"
            )
        ...
        logger.error(
            f"Error handling annotation.created event: {str(e)}", exc_info=True
        )
...
def handle_collection_resource_added(payload: Dict[str, Any]):
    ...
    try:
        ...
        try:
            ...
            logger.info(
                f"Updated user profile for collection add: user={user_id}, resource={resource_id}"
            )
        ...
        logger.error(
            f"Error handling collection.resource_added event: {str(e)}", exc_info=True
        )
