...
def test_annotation_semantic_search(
    ...
    with patch.object(service.embedding_generator, "generate_embedding") as mock_embed:
        ...
        results = service.search_annotations_semantic(
            user_id="test_user", query=input_data["query"], limit=10
        )
...
def test_annotation_semantic_search_no_embeddings(
    db_session, create_test_resource, create_test_annotation
):
    """
    ...
    with patch.object(service.embedding_generator, "generate_embedding") as mock_embed:
        ...
        results = service.search_annotations_semantic(
            user_id="test_user", query="test query", limit=10
        )
...
def test_annotation_semantic_search_empty_query(
    db_session, create_test_resource, create_test_annotation
):
    """
...
def test_annotation_semantic_search_limit(
    db_session, create_test_resource, create_test_annotation
):
    """
...
def test_annotation_semantic_search_user_isolation(
    db_session, create_test_resource, create_test_annotation
):
    """
    ...
    with patch.object(service.embedding_generator, "generate_embedding") as mock_embed:
        ...
        results_user1 = service.search_annotations_semantic(
            user_id="user1", query="test query", limit=10
        )

        # Search as user2
        results_user2 = service.search_annotations_semantic(
            user_id="user2", query="test query", limit=10
        )
