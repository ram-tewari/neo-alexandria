...
class TestABTestingFramework:
    ...
    def test_experiment_creation(self, ab_testing, model_versions):
        ...
        experiment = ab_testing.db.query(ABTestExperiment).filter(
            ABTestExperiment.id == uuid.UUID(experiment_id)
        ).first()
    ...
    def test_prediction_logging(self, ab_testing, model_versions):
        ...
        logs = ab_testing.db.query(PredictionLog).filter(
            PredictionLog.experiment_id == uuid.UUID(experiment_id)
        ).all()
    ...
    def test_experiment_analysis(self, ab_testing, model_versions):
        ...
        assert results['control']['avg_confidence'] < results['treatment']['avg_confidence']
