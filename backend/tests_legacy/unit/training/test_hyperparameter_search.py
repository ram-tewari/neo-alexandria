...
class TestHyperparameterSearchObjective:
    ...
    def test_objective_samples_hyperparameters(self, mock_trainer_class, temp_data_dir, temp_output_dir):
        ...
        mock_trial.suggest_float.assert_called_once_with('learning_rate', 1e-5, 5e-5, log=True)
    ...
    @patch('hyperparameter_search.ClassificationTrainer')
    def test_objective_returns_zero_on_failure(self, mock_trainer_class, temp_data_dir, temp_output_dir):
...
class TestHyperparameterSearchSearch:
    ...
    @patch('hyperparameter_search.ClassificationTrainer')
    def test_search_runs_with_small_n_trials(self, mock_trainer_class, temp_data_dir, temp_output_dir):
    ...
    @patch('hyperparameter_search.ClassificationTrainer')
    def test_search_saves_best_hyperparameters(self, mock_trainer_class, temp_data_dir, temp_output_dir):
    ...
    @patch('hyperparameter_search.ClassificationTrainer')
    def test_search_respects_timeout(self, mock_trainer_class, temp_data_dir, temp_output_dir):
    ...
    @patch('hyperparameter_search.ClassificationTrainer')
    def test_pruning_works_for_unpromising_trials(self, mock_trainer_class, temp_data_dir, temp_output_dir):
