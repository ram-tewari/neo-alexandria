...
@router.get("/resources/{resource_id}/metadata", response_model=ScholarlyMetadataResponse)
...
@router.post("/resources/{resource_id}/metadata/extract", response_model=MetadataExtractionResponse)
async def trigger_metadata_extraction(
    ...
    try:
        ...
        try:
            from .extractor import ScholarlyMetadataExtractor
            extractor = ScholarlyMetadataExtractor(db)
            extractor.extract_metadata(resource_uuid)
            return MetadataExtractionResponse(
                status="completed",
                resource_id=resource_id,
