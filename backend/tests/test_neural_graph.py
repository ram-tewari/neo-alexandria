...
class TestNeuralGraphService:
    ...
    def test_batch_upload_to_qdrant(self):
        ...
        with patch('app.services.neural_graph.QdrantClient', create=True) as mock_qdrant_class, \
             patch('app.services.neural_graph.PointStruct', create=True) as mock_point_struct, \
             patch('app.services.neural_graph.VectorParams', create=True), \
             patch('app.services.neural_graph.Distance', create=True):
    ...
    def test_retry_logic_on_upload_failure(self):
        ...
        with patch('app.services.neural_graph.QdrantClient', create=True) as mock_qdrant_class, \
            ...
            with patch('app.services.neural_graph.time.sleep'):
                # Upload embeddings
                service.upload_embeddings(
                    embeddings=embeddings,
                    file_paths=file_paths,
    ...
    def test_collection_creation(self):
        ...
        with patch('app.services.neural_graph.QdrantClient', create=True) as mock_qdrant_class, \
             patch('app.services.neural_graph.PointStruct', create=True) as mock_point_struct, \
             patch('app.services.neural_graph.VectorParams', create=True) as mock_vector_params, \
             patch('app.services.neural_graph.Distance', create=True):
