...
class TestResourceClassificationFlow:
    ...
    def test_resource_classification_flow(self, client, db_session, mock_event_bus, create_test_resource, create_test_category):
        """
        ...
        **Validates: Requirements 3.4, 3.5, 4.1, 10.2-10.6, 13.1-13.3**
        ...
        with patch("app.modules.taxonomy.classification_service.MLClassificationService") as MockMLService:
            ...
            # Verify database persistence
            classification = db_session.query(ResourceTaxonomy).filter_by(
