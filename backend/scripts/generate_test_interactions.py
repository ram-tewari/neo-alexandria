...
def generate_test_data(num_users=10, interactions_per_user=20):
    ...
    try:
        ...
        for user in users_created:
            ...
            user_resources = random.sample(resources, min(num_interactions, len(resources)))
            ...
            for resource in user_resources:
                ...
                if interaction_type == "view":
                    ...
                    interaction_strength = 0.1 + min(0.3, dwell_time/1000) + 0.1*scroll_depth
        ...
        # Summary
        positive_count = db.query(UserInteraction).filter(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--interactions", type=int, default=20, help="Avg interactions per user")
