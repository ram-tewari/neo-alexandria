...
class TestCollectionAggregation:
    ...
    def test_mean_vector_calculation(self, db_session, create_test_resource, create_test_collection):
        """
        ...
        **Validates: Requirements 5.1, 5.2, 8.2, 8.3**
        ...
        for i, (actual, expected) in enumerate(zip(result_embedding, expected_embedding)):
    ...
    def test_single_resource_embedding(self, db_session, create_test_resource, create_test_collection):
        """
        ...
        **Validates: Requirements 5.1, 5.2, 8.2, 8.3**
        ...
        # Create test collection
        collection = create_test_collection(
            name="Single Resource Collection",
            owner_id="test_user"
        )
