...
class AlertManager:
    ...
    def __init__(
        ...
        logger.info(
            f"Thresholds - Error rate: {error_rate_threshold * 100}%, "
    ...
    def send_slack_alert(self, alerts: List[str], metrics: Dict[str, Any]) -> bool:
        ...
        message = {
            ...
            "blocks": [
                {
                    "type": "header",
                    "text": {"type": "plain_text", "text": "🚨 ML Model Alert"},
                },
                {
                    "type": "section",
                    "text": {"type": "mrkdwn", "text": alert_text + metrics_summary},
                },
            ],
        }
    ...
    def send_custom_alert(
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    f"Failed to send custom alert: {response.status_code} - {response.text}"
                )
                return False
