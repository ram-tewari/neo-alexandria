...
class TestClassificationPrediction:
    ...
    def test_rank_validation_zero(self):
        ...
        with pytest.raises(ValueError, match="rank must be positive"):
            ClassificationPrediction(taxonomy_id="node_123", confidence=0.95, rank=0)

    def test_rank_validation_negative(self):
        """Test that negative rank raises ValueError."""
        with pytest.raises(ValueError, match="rank must be positive"):
            ClassificationPrediction(taxonomy_id="node_123", confidence=0.95, rank=-1)
    ...
    def test_taxonomy_id_validation_empty(self):
        ...
        with pytest.raises(ValueError, match="taxonomy_id cannot be empty"):
            ClassificationPrediction(taxonomy_id="", confidence=0.95, rank=1)
    ...
    def test_is_medium_confidence_custom_thresholds(self):
        ...
        assert (
            pred.is_medium_confidence(low_threshold=0.65, high_threshold=0.8) is False
        )
    ...
    def test_to_dict(self):
        ...
        assert result == {"taxonomy_id": "node_123", "confidence": 0.95, "rank": 1}
