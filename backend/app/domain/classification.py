...
from . import ValueObject, validate_range, validate_positive
...
class ClassificationPrediction(ValueObject):
    ...
    def is_medium_confidence(
        self, low_threshold: float = 0.5, high_threshold: float = 0.8
    ) -> bool:
        """
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ClassificationResult":
        ...
        predictions = [
            ClassificationPrediction(
                taxonomy_id=p["taxonomy_id"], confidence=p["confidence"], rank=p["rank"]
            )
