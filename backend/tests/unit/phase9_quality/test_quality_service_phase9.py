...
# Direct imports
import backend.app.database.base as base_module
import backend.app.database.models as models_module
import backend.app.services.quality_service as quality_module
...
def test_quality_degradation_monitoring():
    ...
    try:
        ...
        print("✓ Resource 3 correctly skipped (recent computation)")
