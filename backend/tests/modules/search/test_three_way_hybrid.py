...
class TestThreeWayHybridSearch:
    ...
    def test_three_way_search_with_reranking(self, db_session: Session, create_test_resource):
    ...
    def test_three_way_search_without_adaptive_weighting(self, db_session: Session, create_test_resource):
        """Test three-way search with equal weights."""
        # Create test resource
        create_test_resource(
            title="Test Resource",
            description="Test content for search"
        )
    ...
    def test_three_way_search_pagination(self, db_session: Session, create_test_resource):
        """Test pagination in three-way search."""
        # Create multiple test resources
        for i in range(15):
            create_test_resource(
                title=f"Resource {i}",
                description=f"Content about topic {i}"
            )
    ...
    def test_three_way_search_no_matches(self, db_session: Session, create_test_resource):
