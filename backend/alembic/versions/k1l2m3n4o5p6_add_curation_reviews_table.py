...
def upgrade() -> None:
    ...
    if 'curation_reviews' not in existing_tables:
        ...
        op.create_index('idx_curation_reviews_resource', 'curation_reviews', ['resource_id'])
        op.create_index('idx_curation_reviews_curator', 'curation_reviews', ['curator_id'])
        op.create_index('idx_curation_reviews_timestamp', 'curation_reviews', ['timestamp'])
