...
def main():
    ...
    for endpoint in endpoints:
        ...
        exists, func_name = verify_endpoint_exists(
            content, endpoint["name"], endpoint["method"], endpoint["path"]
        )
        ...
        if exists:
            ...
            if endpoint["path"] == "/classify/":
                ...
                if "identify_uncertain_samples" in content:
                    print(
                        "  ✓ Calls MLClassificationService.identify_uncertain_samples()"
                    )
                ...
                if "update_from_human_feedback" in content:
                    print(
                        "  ✓ Calls MLClassificationService.update_from_human_feedback()"
                    )
