...
class TestCollectionLifecycle:
    ...
    def test_collection_creation_flow(self, client, db_session, mock_event_bus):
        ...
        **Validates: Requirements 5.2, 5.3, 10.2-10.6, 13.1-13.3**
        ...
        collection = db_session.query(Collection).filter(
    ...
    def test_add_resource_to_collection_flow(self, client, db_session, mock_event_bus, create_test_resource, create_test_collection):
        """
        ...
        **Validates: Requirements 5.2, 5.3, 10.2-10.6, 13.1-13.3**
        ...
        association = db_session.query(CollectionResource).filter(
        ...
        updated_collection = db_session.query(Collection).filter(
    ...
    def test_remove_resource_from_collection_flow(self, client, db_session, create_test_resource, create_test_collection):
        """
        ...
        **Validates: Requirements 5.2, 5.3, 10.2-10.6**
        ...
        assert updated_collection is not None, "Collection should still exist in database"
