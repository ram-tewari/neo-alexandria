...
class ClassificationTreeNode(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="Detailed description of the classification"
    )
    keywords: List[str] = Field(
        default_factory=list, description="Keywords associated with this classification"
    )
    children: List[ClassificationTreeNode] = Field(
        default_factory=list, description="Child classification nodes"
    )
...
class ClassificationTreeResponse(BaseModel):
    ...
    tree: List[ClassificationTreeNode] = Field(
        description="Top-level classification nodes"
    )
