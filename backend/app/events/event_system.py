...
class EventEmitter:
    ...
    def on(
        ...
        """
        handler_info = {"handler": handler, "async": async_handler}
    ...
    def off(self, event_name: str, handler: Callable) -> None:
        ...
        self._listeners[event_name] = [
            h for h in self._listeners[event_name] if h["handler"] != handler
        ]
    ...
    def get_subscribers(
        ...
        if event_name:
            return {
                event_name: [h["handler"] for h in self._listeners.get(event_name, [])]
            }
