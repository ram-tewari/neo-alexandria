...
class TestOOMErrorHandling:
    ...
    @patch('backend.scripts.training.train_classification.ClassificationTrainer._train_with_batch_size')
    ...
    def test_oom_error_clears_gpu_cache(self, mock_empty_cache, mock_cuda_available, mock_train, temp_dirs):
