...
class TestResourcesAPI:
    ...
    def test_create_resource_success(
        self, client, test_db, mock_fetch_url, mock_archive_local
    ):
    ...
    def test_create_resource_minimal_payload(
        self, client, test_db, mock_fetch_url, mock_archive_local
    ):
    ...
    def test_create_resource_with_all_fields(
        self, client, test_db, mock_fetch_url, mock_archive_local
    ):
    ...
    def test_create_resource_database_error(
        self, client, test_db, mock_fetch_url, mock_archive_local
    ):
    ...
    def test_create_resource_extra_fields(
        self, client, test_db, mock_fetch_url, mock_archive_local
    ):
    ...
    def test_create_resource_response_model(
        self, client, test_db, mock_fetch_url, mock_archive_local
    ):
    ...
    def test_create_resource_multiple_requests(
        self, client, test_db, mock_fetch_url, mock_archive_local
    ):
    ...
    def test_create_resource_concurrent_requests(
        self, client, test_db, mock_fetch_url, mock_archive_local
    ):
