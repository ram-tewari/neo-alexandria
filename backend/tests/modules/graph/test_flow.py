...
class TestGraphIntegrationFlow:
    ...
    def test_citation_extraction_flow(self, client, db_session, mock_event_bus, create_test_resource):
        """
        ...
        try:
            ...
            for call in mock_event_bus.call_args_list:
                ...
                if event_type == "citation.extracted":
                    ...
                    assert len(event_payload["citations"]) == len(extracted_citations), (
