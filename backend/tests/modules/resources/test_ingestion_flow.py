...
def test_create_resource_success(client: TestClient, db_session: Session, mock_event_bus: MagicMock):
    """
...
def test_create_resource_missing_url(client: TestClient, mock_event_bus: MagicMock):
    ...
    if len(expected_events) == 0:
        ...
        resource_created_calls = [
            call for call in mock_event_bus.call_args_list
...
def test_create_resource_duplicate_url(client: TestClient, db_session: Session, create_test_resource, mock_event_bus: MagicMock):
    """
